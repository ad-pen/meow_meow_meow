...
namespace jVision.Server.Migrations
{
    ...
    [Migration("20260901220000_multi-feature-baseline")]
    partial class multifeaturebaseline
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("jVision.Server.Models.Box", b =>
                {
                    b.Property<int>("BoxId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<string>("Comments").HasColumnType("TEXT");
                    b.Property<string>("Hostname").HasColumnType("TEXT");
                    b.Property<string>("Ip").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("Os").HasColumnType("TEXT");
                    b.Property<string>("Stage").HasColumnType("TEXT");
                    b.Property<string>("Standing").HasColumnType("TEXT");
                    b.Property<string>("State").HasColumnType("TEXT");
                    b.Property<string>("Subnet").HasColumnType("TEXT");
                    b.Property<string>("UserId").HasColumnType("TEXT");
                    b.HasKey("BoxId");
                    b.HasIndex("UserId");
                    b.ToTable("Boxes");
            ...
            modelBuilder.Entity("jVision.Server.Models.Service", b =>
                {
                    b.Property<int>("ServiceId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<int>("BoxId").HasColumnType("INTEGER");
                    b.Property<string>("Name").HasColumnType("TEXT");
                    b.Property<int>("Port").HasColumnType("INTEGER");
                    b.Property<string>("Protocol").HasColumnType("TEXT");
                    b.Property<string>("Script").HasColumnType("TEXT");
                    b.Property<string>("State").HasColumnType("TEXT");
            ...
            modelBuilder.Entity("jVision.Shared.Models.Cred", b =>
                {
                    b.Property<int>("CredId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<string>("Origin").HasColumnType("TEXT");
                    ...
                    b.Property<bool>("Verified").HasColumnType("INTEGER");
                    b.HasKey("CredId");
                    b.ToTable("Cred");
                });
            ...
            modelBuilder.Entity("jVision.Shared.Models.CredUsage", b =>
                {
                    b.Property<int>("CredUsageId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<int?>("BoxId").HasColumnType("INTEGER");
                    b.Property<int>("CredId").HasColumnType("INTEGER");
                    b.Property<string>("Ip").HasColumnType("TEXT");
                    b.Property<string>("Notes").HasColumnType("TEXT");
                    b.Property<int?>("Port").HasColumnType("INTEGER");
                    b.Property<string>("ServiceName").HasColumnType("TEXT");
                    b.Property<string>("Status").HasColumnType("TEXT");
                    b.Property<DateTime>("TestedAt").HasColumnType("TEXT");
                    b.Property<string>("TestedBy").HasColumnType("TEXT");
            ...
            modelBuilder.Entity("jVision.Shared.Models.CreatedAccount", b =>
                {
                    b.Property<int>("CreatedAccountId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<int?>("BoxId").HasColumnType("INTEGER");
                    b.Property<DateTime>("CreatedAt").HasColumnType("TEXT");
                    b.Property<string>("CreatedBy").HasColumnType("TEXT");
                    b.Property<string>("Ip").HasColumnType("TEXT");
                    b.Property<int?>("LinkedCredId").HasColumnType("INTEGER");
                    b.Property<string>("Notes").HasColumnType("TEXT");
                    b.Property<string>("Password").HasColumnType("TEXT");
                    b.Property<string>("Privilege").HasColumnType("TEXT");
                    b.Property<string>("Service").HasColumnType("TEXT");
            ...
            modelBuilder.Entity("jVision.Shared.Models.CustomTab", b =>
                {
                    b.Property<int>("CustomTabId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("jVision.Shared.Models.JvisUser", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<string>("FirstName").HasColumnType("TEXT");
                    b.Property<string>("LastName").HasColumnType("TEXT");
                    b.HasKey("Id");
                    b.ToTable("JvisUsers");
                });

            modelBuilder.Entity("jVision.Shared.Models.LogEntry", b =>
                {
                    b.Property<int>("LogEntryId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<string>("Line").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("Operator").IsRequired().HasColumnType("TEXT");
            ...
            modelBuilder.Entity("jVision.Shared.Models.PivotEdge", b =>
                {
                    b.Property<int>("PivotEdgeId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<int?>("CredId").HasColumnType("INTEGER");
                    b.Property<DateTime>("CreatedAt").HasColumnType("TEXT");
                    b.Property<string>("CreatedBy").HasColumnType("TEXT");
                    b.Property<string>("Label").HasColumnType("TEXT");
                    b.Property<string>("SourceIp").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("TargetIp").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("Technique").HasColumnType("TEXT");
            ...
            modelBuilder.Entity("jVision.Shared.Models.ScanUpload", b =>
                {
                    b.Property<int>("ScanUploadId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    ...
                    b.Property<string>("StoredPath").IsRequired().HasColumnType("TEXT");
                    b.Property<DateTime>("UploadedAt").HasColumnType("TEXT");
                    b.Property<string>("Uploader").IsRequired().HasColumnType("TEXT");
                    b.HasKey("ScanUploadId");
            ...
            modelBuilder.Entity("jVision.Shared.Models.ScratchPage", b =>
                {
                    b.Property<int>("ScratchPageId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<string>("Content").HasColumnType("TEXT");
                    b.Property<string>("Title").IsRequired().HasColumnType("TEXT");
                    b.Property<DateTime>("UpdatedAt").HasColumnType("TEXT");
                    b.Property<string>("UpdatedBy").HasColumnType("TEXT");
            ...
            modelBuilder.Entity("jVision.Shared.Models.TeamIp", b =>
                {
                    b.Property<int>("TeamIpId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<DateTime>("FirstSeen").HasColumnType("TEXT");
                    b.Property<string>("Ip").IsRequired().HasColumnType("TEXT");
                    b.Property<DateTime>("LastSeen").HasColumnType("TEXT");
                    b.Property<string>("Operator").IsRequired().HasColumnType("TEXT");
                    b.HasKey("TeamIpId");
                    b.HasIndex("Operator", "Ip").IsUnique();
                    b.ToTable("TeamIp");
                });

            modelBuilder.Entity("jVision.Shared.Models.UploadedScanHost", b =>
                {
                    b.Property<int>("UploadedScanHostId").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<string>("Hostname").HasColumnType("TEXT");
                    b.Property<string>("Ip").HasColumnType("TEXT");
                    b.Property<int>("ScanUploadId").HasColumnType("INTEGER");
                    b.Property<string>("ServicesJson").HasColumnType("TEXT");
                    b.HasKey("UploadedScanHostId");
                    b.HasIndex("Ip");
            ...
            modelBuilder.Entity("jVision.Server.Models.Box", b =>
                {
                    b.HasOne("jVision.Server.Models.ApplicationUser", "User")
                        .WithMany("Boxes").HasForeignKey("UserId");
                    b.Navigation("User");
                });
            ...
            modelBuilder.Entity("jVision.Server.Models.Service", b =>
                {
                    b.HasOne("jVision.Server.Models.Box", null)
                        .WithMany("Services").HasForeignKey("BoxId")
                        .OnDelete(DeleteBehavior.Cascade).IsRequired();
                });
